...
[Xhat_2a,Xhatl_2a,dxhat_2a,dxhatl_2a,P_2a,Pl_2a,y_2a,yhat_2a] = SRIF(DCO_cutoff_t,zeros(7,1),P0,Q,DCO_cutoff_data,V,DCO_cutoff_Xnom,constants,stations,5);
...
c = zeros(11,1);
Pcc = diag([1e3 1e4 1e-2 1e-2 1e-2 1e-2 1e-2 1e-2 1e-2 1e-2 1e-2].^2);

[Xhat_2bcc,dxhat_2bcc,P_2bcc,Pc_2bcc,Pxx_2bcc,S_2bcc,y_2bcc,yhat_2bcc,Psi] = SRIFConsiderCov(DCO_cutoff_t,zeros(7,1),c,P0,Pcc,DCO_cutoff_data,V,X0,constants,stations);
plot_consider_effects(DCO_cutoff_t,P_2bcc,Pxx_2bcc,S_2bcc,Pcc,consider_labels)

%% OD1: Add in grav parameters, station positions
...
%% OD2: DSS 65 and maneuver estimation
X0_new = [X0 rDSS65' 0 0 0];
sigma_dV = 1e-4;
P0_new = blkdiag(P0, diag([1e-2 1e-2 1e-2 sigma_dV sigma_dV sigma_dV].^2));
constants.tm = 18675000;
% constants.tm = 18674940;

[Xhat_2b,Xhatl_2b,dxhat_2b,dxhatl_2b,P_2b,Pl_2b,y_2b,yhat_2b,yhat1_2b ] = SRIF3(DCO_cutoff_t,zeros(13,1),P0_new,Q,DCO_cutoff_data,V,X0_new,constants,stations,5);
