function [measurement,gs_state] = genSingleMeasurement(t,stations,current_station,constants,sc_state)
%{
Inputs:
...
% Rotate station to LLA
station_lla = ecef2lla(current_station_Rs'./1000);
...
rR_ecef = sc_pos_ecef - current_station_Rs;
rR_top = Rtop*rR_ecef;
...
if isempty(el_mask) || el_angle >= el_mask
    ...
    measurement = [current_id, rho, rho_dot, rad2deg(el_angle)];
